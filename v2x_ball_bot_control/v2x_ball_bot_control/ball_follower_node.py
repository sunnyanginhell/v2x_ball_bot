...
class BallFollowerNode(Node):
    def __init__(self):
        ...
        self.k_angular = self.declare_parameter('k_angular', 0.05).value
        self.target_dist = self.declare_parameter('target_dist_m', 0.3).value
        ...
        self.deadband_yaw_deg = self.declare_parameter('deadband_yaw_deg', 90.0).value
        self.ball_timeout = self.declare_parameter('ball_timeout_sec', 1.0).value
        self.y_scale_correction = self.declare_parameter('y_scale_correction', 0.7).value
