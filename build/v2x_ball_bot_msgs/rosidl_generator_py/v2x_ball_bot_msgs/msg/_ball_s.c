...
bool v2x_ball_bot_msgs__msg__ball__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_ball_bot_msgs.msg._ball.Ball", full_classname_dest, 32) == 0);
  }
  v2x_ball_bot_msgs__msg__Ball * ros_message = _ros_message;
  {  // stamp
...
PyObject * v2x_ball_bot_msgs__msg__ball__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_ball_bot_msgs.msg._ball");
