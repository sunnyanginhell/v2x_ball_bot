...
bool v2x_ball_bot_msgs__msg__ball_pixel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_ball_bot_msgs.msg._ball_pixel.BallPixel", full_classname_dest, 43) == 0);
  }
  v2x_ball_bot_msgs__msg__BallPixel * ros_message = _ros_message;
  {  // u
...
{
  /* NOTE(esteve): Call constructor of BallPixel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_ball_bot_msgs.msg._ball_pixel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BallPixel");
