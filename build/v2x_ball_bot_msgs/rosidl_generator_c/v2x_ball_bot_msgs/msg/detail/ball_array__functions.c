...
v2x_ball_bot_msgs__msg__BallArray__init(v2x_ball_bot_msgs__msg__BallArray * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    v2x_ball_bot_msgs__msg__BallArray__fini(msg);
    return false;
  }
  // balls
  if (!v2x_ball_bot_msgs__msg__Ball__Sequence__init(&msg->balls, 0)) {
    v2x_ball_bot_msgs__msg__BallArray__fini(msg);
    return false;
  }
  return true;
...
v2x_ball_bot_msgs__msg__BallArray__fini(v2x_ball_bot_msgs__msg__BallArray * msg)
{
  ...
  // balls
  v2x_ball_bot_msgs__msg__Ball__Sequence__fini(&msg->balls);
}
...
v2x_ball_bot_msgs__msg__BallArray__are_equal(const v2x_ball_bot_msgs__msg__BallArray * lhs, const v2x_ball_bot_msgs__msg__BallArray * rhs)
{
  ...
  // balls
  if (!v2x_ball_bot_msgs__msg__Ball__Sequence__are_equal(
      &(lhs->balls), &(rhs->balls)))
  {
    return false;
  }
  ...
  v2x_ball_bot_msgs__msg__BallArray * output)
{
  ...
  // balls
  if (!v2x_ball_bot_msgs__msg__Ball__Sequence__copy(
...
v2x_ball_bot_msgs__msg__BallArray__create()
{
  ...
  v2x_ball_bot_msgs__msg__BallArray * msg = (v2x_ball_bot_msgs__msg__BallArray *)allocator.allocate(sizeof(v2x_ball_bot_msgs__msg__BallArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_ball_bot_msgs__msg__BallArray));
  bool success = v2x_ball_bot_msgs__msg__BallArray__init(msg);
  if (!success) {
...
v2x_ball_bot_msgs__msg__BallArray__Sequence__init(v2x_ball_bot_msgs__msg__BallArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_ball_bot_msgs__msg__BallArray * data = NULL;

  if (size) {
    data = (v2x_ball_bot_msgs__msg__BallArray *)allocator.zero_allocate(size, sizeof(v2x_ball_bot_msgs__msg__BallArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_ball_bot_msgs__msg__BallArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_ball_bot_msgs__msg__BallArray__fini(&data[i - 1]);
      }
...
v2x_ball_bot_msgs__msg__BallArray__Sequence__fini(v2x_ball_bot_msgs__msg__BallArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_ball_bot_msgs__msg__BallArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_ball_bot_msgs__msg__BallArray__Sequence * array = (v2x_ball_bot_msgs__msg__BallArray__Sequence *)allocator.allocate(sizeof(v2x_ball_bot_msgs__msg__BallArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_ball_bot_msgs__msg__BallArray__Sequence__init(array, size);
  if (!success) {
...
v2x_ball_bot_msgs__msg__BallArray__Sequence__destroy(v2x_ball_bot_msgs__msg__BallArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_ball_bot_msgs__msg__BallArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_ball_bot_msgs__msg__BallArray__Sequence__are_equal(const v2x_ball_bot_msgs__msg__BallArray__Sequence * lhs, const v2x_ball_bot_msgs__msg__BallArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_ball_bot_msgs__msg__BallArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_ball_bot_msgs__msg__BallArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_ball_bot_msgs__msg__BallArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_ball_bot_msgs__msg__BallArray * data =
      (v2x_ball_bot_msgs__msg__BallArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_ball_bot_msgs__msg__BallArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_ball_bot_msgs__msg__BallArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!v2x_ball_bot_msgs__msg__BallArray__copy(
