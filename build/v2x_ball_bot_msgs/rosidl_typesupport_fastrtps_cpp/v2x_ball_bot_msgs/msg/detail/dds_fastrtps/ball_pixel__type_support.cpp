...
#include "v2x_ball_bot_msgs/msg/detail/ball_pixel__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_ball_bot_msgs::msg::BallPixel;
    is_plain =
      (
      offsetof(DataType, v) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const v2x_ball_bot_msgs::msg::BallPixel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_ball_bot_msgs::msg::BallPixel *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BallPixel__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const v2x_ball_bot_msgs::msg::BallPixel *>(
...
static size_t _BallPixel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BallPixel(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BallPixel__callbacks = {
...
static rosidl_message_type_support_t _BallPixel__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BallPixel__callbacks,
...
{
  return &v2x_ball_bot_msgs::msg::typesupport_fastrtps_cpp::_BallPixel__handle;
}
